...
namespace pr_5_sharp {
    ...
    public partial class CompanyDataSet : global::System.Data.DataSet {
        ...
        public partial class СотрудникиDataTable : global::System.Data.TypedTableBase<СотрудникиRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public СотрудникиRow AddСотрудникиRow(string Имя, string Должность, System.DateTime ДатаРождения, int Оклад) {
...
namespace pr_5_sharp.CompanyDataSetTableAdapters {
    ...
    public partial class СотрудникиTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Сотрудники` (`Имя`, `Должность`, `ДатаРождения`, `Оклад`) VALUES (?," +
                " ?, ?, ?)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::pr_5_sharp.Properties.Settings.Default.CompanyConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Имя, Должность, ДатаРождения, Оклад FROM Сотрудники";
        ...
        public virtual int Fill(CompanyDataSet.СотрудникиDataTable dataTable) {
        ...
        public virtual CompanyDataSet.СотрудникиDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CompanyDataSet.СотрудникиDataTable dataTable = new CompanyDataSet.СотрудникиDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CompanyDataSet.СотрудникиDataTable dataTable) {
        ...
        public virtual int Insert(string Имя, string Должность, global::System.Nullable<global::System.DateTime> ДатаРождения, global::System.Nullable<int> Оклад) {
            if ((Имя == null)) {
